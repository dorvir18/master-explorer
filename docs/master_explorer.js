...
(function () {
  ...
  MX.router = (function () {
    ...
    function renderTap(mission, variant) {
      ...
      const host = mountInteractive(`
        <div class="mx-interactive">
          <div class="mx-prompt">${escapeHtml(variant?.prompt || '')}</div>
    ...
    function renderFinal(mission, variant) {
      ...
      host.innerHTML = `
        <div class="mx-interactive">
          <div class="mx-prompt">${escapeHtml(variant?.prompt || 'ФИНАЛ!')}</div>
  ...
  window.Final = (function () {
    ...
    function renderFinal(containerEl) {
      ...
      containerEl.innerHTML = `
        <div class="mx-interactive">
          <div class="mx-prompt">
            ${ok ? 'Ты прошёл(а) все миссии! Нажми кнопку и получи сертификат.' : 'Сначала пройди все миссии.'}
          </div>
  ...
  window.Certificate = (function () {
    ...
    function render(containerEl) {
      containerEl.innerHTML = `
        <div class="mx-interactive">
          <div class="mx-prompt">Твой сертификат готов!</div>
